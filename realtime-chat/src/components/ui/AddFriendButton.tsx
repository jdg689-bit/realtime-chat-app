...
const AddFriendButton: FC<AddFriendButtonProps> = ({}) => {
    ...
    // Takes one object as optional argument -> in this case resolver
    // Resolver integrates with preferred schema validation library (zod in this case)
    ...
    const addFriend = async (email: string) => {
        try {
            ...
            setError('email', { message: 'Something went wrong.' }) // Source of error can't be pinpointed
        }
    }
